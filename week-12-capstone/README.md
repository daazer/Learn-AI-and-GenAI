...
Focus: Integrating the full stack into end-to-end mini generative systems
...
- [ ] Plan and execute scoped end-to-end GenAI projects.
- [ ] Train and evaluate at least one text and one image generator.
- [ ] Present results clearly with limitations and next-step recommendations.
- [ ] Demonstrate reproducibility and engineering quality in final artifacts.

## Core Tasks
- [ ] 83. Define a capstone scope for a mini GPT style model.
- [ ] 84. Prepare and clean a small text dataset.
- [ ] 85. Train a small transformer end to end.
- [ ] 86. Evaluate text generation quality and perplexity.
- [ ] 87. Define a capstone scope for a mini image generator.
- [ ] 88. Prepare a small image dataset.
- [ ] 89. Train a small image generator and sample outputs.
- [ ] 90. Write a final report with results and next steps.
...
Deliver two mini capstones (text + image) with reproducible training scripts and a final report.
...
## Quality Checklist
- [ ] Both capstones run from documented commands.
- [ ] Final report includes metrics, samples, failure analysis, and roadmap.
- [ ] Repository is organized for external review/use.
