# Week 04 Probability and Statistics

Focus: Uncertainty, distributions, and information measures for learning systems
...
- [ ] Apply core probability rules to simple ML scenarios.
- [ ] Estimate key statistics from synthetic samples.
- [ ] Compute entropy, cross-entropy, and KL divergence correctly.
- [ ] Use Bayes rule for a transparent toy inference problem.

## Core Tasks
- [ ] 23. Learn probability basics: events, conditional probability.
- [ ] 24. Implement sampling from simple distributions.
- [ ] 25. Learn expectation, variance, covariance.
- [ ] 26. Implement estimation of mean and variance from samples.
- [ ] 27. Learn Bayes rule and apply to a toy example.
- [ ] 28. Learn entropy and cross entropy.
- [ ] 29. Implement KL divergence on simple distributions.
- [ ] 30. Write a summary note on uncertainty in models.
...
Build a probability sandbox notebook/scripts for sampling, estimation, Bayes updates, and information metrics.
...
## Quality Checklist
- [ ] Sampling experiments include at least 3 distributions.
- [ ] KL implementation validated on known toy distributions.
- [ ] Uncertainty note includes at least 3 model-related examples.
