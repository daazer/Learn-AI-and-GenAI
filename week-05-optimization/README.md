...
Focus: Gradient-based learning fundamentals and objective design
...
- [ ] Understand gradient meaning and optimization dynamics.
- [ ] Implement and verify gradient-based updates numerically.
- [ ] Train linear and logistic regression models from scratch.
- [ ] Compare optimization behavior under different learning rates.

## Core Tasks
- [ ] 31. Learn calculus basics: derivatives and gradients.
- [ ] 32. Implement numerical gradient checking.
- [ ] 33. Learn gradient descent and learning rate schedules.
- [ ] 34. Implement gradient descent for linear regression.
- [ ] 35. Learn loss functions: MSE and cross entropy.
- [ ] 36. Implement logistic regression from scratch.
- [ ] 37. Write a summary note on optimization tradeoffs.
...
Create an optimization lab with gradient checks, LR schedule experiments, and logistic regression training curves.
...
## Quality Checklist
- [ ] Numerical and analytical gradients closely match.
- [ ] Training curves logged for at least 3 LR values.
- [ ] Binary classifier reports accuracy/precision/recall.
