...
Focus: Python basics, numeric thinking, and scientific workflow habits
...
- [ ] Set up and manage a reproducible Python workspace.
- [ ] Write clear, testable Python scripts and small functions.
- [ ] Use NumPy arrays and vectorized operations for basic numerical work.
- [ ] Visualize simple distributions and trends with Matplotlib.

## Core Tasks
- [ ] 1. Set up Python environment and project structure.
- [ ] 2. Learn Python basics: variables, control flow, functions.
- [ ] 3. Learn Python data structures: lists, dicts, sets, tuples.
- [ ] 4. Learn NumPy arrays and vectorized operations.
- [ ] 5. Learn basic plotting with Matplotlib.
- [ ] 6. Implement simple numerical experiments: mean, variance, histogram.
- [ ] 7. Write a summary note on linear vs nonlinear functions.
...
Build a mini numeric-lab script that loads sample values, computes descriptive stats, and produces at least two plots (histogram + line/scatter).
...
## Quality Checklist
- [ ] All setup commands documented in notes/setup.md.
- [ ] At least 3 executable scripts in code/.
- [ ] At least 2 plots exported into artifacts/.
