...
Focus: Core vector and matrix operations for ML intuition
...
- [ ] Reason about vectors and matrices geometrically and computationally.
- [ ] Implement and validate matrix operations from first principles.
- [ ] Explain eigendecomposition/SVD intuition in practical ML terms.
- [ ] Run PCA on toy datasets and interpret principal directions.

## Core Tasks
- [ ] 16. Learn vectors, dot product, norms.
- [ ] 17. Implement vector operations in NumPy.
- [ ] 18. Learn matrices, matrix multiplication.
- [ ] 19. Implement matrix multiplication manually and with NumPy.
- [ ] 20. Learn eigenvalues and singular value intuition.
- [ ] 21. Implement a small PCA demo on toy data.
- [ ] 22. Write a summary note on why linear algebra matters for AI.
...
Create a linear algebra workbook with reproducible experiments for norms, projections, matrix multiplication, and PCA.
...
## Quality Checklist
- [ ] Manual and NumPy matrix multiplication outputs match.
- [ ] PCA experiment includes explained variance plot.
- [ ] Concept note links linear algebra concepts to model internals.
