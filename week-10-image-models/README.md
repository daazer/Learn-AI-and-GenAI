...
Focus: Generative image modeling foundations from CNNs to tiny diffusion
...
- [ ] Process and model image tensors correctly.
- [ ] Implement convolutional and autoencoding models.
- [ ] Understand latent-variable and diffusion-based generation intuition.
- [ ] Generate and compare outputs from multiple image approaches.

## Core Tasks
- [ ] 68. Learn image representation and convolution basics.
- [ ] 69. Implement a simple CNN from scratch.
- [ ] 70. Train the CNN on a small image dataset.
- [ ] 71. Learn autoencoders and implement one.
- [ ] 72. Implement a variational autoencoder.
- [ ] 73. Learn diffusion model intuition.
- [ ] 74. Implement a tiny diffusion model on small images.
- [ ] 75. Write a summary note on generative images.
...
Create an image-generation lab with CNN baseline, autoencoder/VAE, and tiny diffusion prototype.
...
## Quality Checklist
- [ ] Reconstruction quality tracked for AE/VAE.
- [ ] At least one diffusion sampling script runs end-to-end.
- [ ] Artifacts include input/reconstruction/sample grids.
